...
const unsigned char *evab::PictosetVerticalProgressBar::GetTile(unsigned char blockType, unsigned char fillNumber)
{
...
const unsigned char *PictosetHorizontalProgressBar::GetTile(unsigned char blockType, unsigned char fillNumber)
{
    const static unsigned char picto_11[] PROGMEM = {
        8, 8,
...
const unsigned char *PictosetVerticalScrollBar::GetTile(unsigned char blockType, unsigned char fillNumber)
{
...
const unsigned char *PictosetHorizontalScrollBar::GetTile(unsigned char blockType, unsigned char fillNumber)
{
    static const unsigned char picto_10[] PROGMEM = {
        8, 8,  // 8x8
        0x7e, 0xc3, 0x81, 0x81, 0x81, 0x81, 0x81, 0x81
