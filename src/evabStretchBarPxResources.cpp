...
const unsigned char *VerticalProgressBarTileset::GetTile(unsigned char blockType, unsigned char fillNumber)
{
...
const unsigned char *HorizontalProgressBarTileset::GetTile(unsigned char blockType, unsigned char fillNumber)
{
    const static unsigned char picto_11[] PROGMEM = {
        8, 8,
...
const unsigned char *VerticalScrollBarTileset::GetTile(unsigned char blockType, unsigned char fillNumber)
{
...
const unsigned char *HorizontalScrollBarTileset::GetTile(unsigned char blockType, unsigned char fillNumber)
{
    static const unsigned char picto_10[] PROGMEM = {
        8, 8,  // 8x8
        0x7e, 0xc3, 0x81, 0x81, 0x81, 0x81, 0x81, 0x81
