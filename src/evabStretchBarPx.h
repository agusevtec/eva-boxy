...
namespace evab
{
    ...
    /**
     * @brief Stretch bar input element with Tilesetgram support
     *
     * Displays a progress/scroll bar using Tilesetgrams with variable fill levels.
     *
     * @tparam TTileset Tileset class providing Tilesetgram data
     * @tparam TOrientationTilesetPolicy Policy for orientation (vertical/horizontal)
     */
    ...
    public:
        /**
         * @brief Constructor for StretchBarPx
         *
