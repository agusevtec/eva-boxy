...
namespace evab
{
     ...
     *
     * Grid provides a fluent interface for organizing UI elements in a rest.
     * Each CutRow()/CutCol() returns a new Grid representing the cell.
     *
     * @code
     * Grid rest({0,0}, {16,8});
    ...
    public:
         ...
         * @return Grid New rest representing the row
         */
         ...
         * @return Grid New rest representing the column
         */
