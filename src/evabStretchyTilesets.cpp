...
const uint8_t *evab::TilesetHProgressbar::GetTile(unsigned char blockType, unsigned char fillNumber)
{
    const static uint8_t picto_11[] PROGMEM = {
        8, 8,
...
const uint8_t *evab::TilesetVScrollbar::GetTile(unsigned char blockType, unsigned char fillNumber)
{
...
const uint8_t *evab::TilesetHScrollbar::GetTile(unsigned char blockType, unsigned char fillNumber)
{
    static const uint8_t picto_10[] PROGMEM = {
        8, 8,  // 8x8
        0x7e, 0xc3, 0x81, 0x81, 0x81, 0x81, 0x81, 0x81
