...
const unsigned char *evab::AlbumStretchyVerticalProgressBar::GetTile(unsigned char blockType, unsigned char fillNumber)
{

    const static unsigned char picto_11[] PROGMEM = {
        8, 8,
        0x7f, 0xc0, 0x80, 0x80, 0x80, 0x80, 0xc0, 0x7f};
    const static unsigned char picto_12[] PROGMEM = {
        8, 8,
        0x7f, 0xc0, 0x98, 0xbc, 0xbc, 0x98, 0xc0, 0x7f};
    const static unsigned char picto_13[] PROGMEM = {
        8, 8,
        0x7f, 0xc0, 0x9e, 0xbf, 0xbf, 0x9e, 0xc0, 0x7f};
    const static unsigned char picto_14[] PROGMEM = {
        8, 8,
        0x7f, 0xc0, 0x9f, 0xbf, 0xbf, 0x9f, 0xc0, 0x7f};
    const static unsigned char picto_20[] PROGMEM = {
        8, 8,
        0xff, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xff};
    const static unsigned char picto_21[] PROGMEM = {
        8, 8,
        0xff, 0x00, 0x80, 0xc0, 0xc0, 0x80, 0x00, 0xff};
    const static unsigned char picto_22[] PROGMEM = {
        8, 8,
        0xff, 0x00, 0xf0, 0xf8, 0xf8, 0xf0, 0x00, 0xff};
    const static unsigned char picto_23[] PROGMEM = {
        8, 8,
        0xff, 0x00, 0xfe, 0xff, 0xff, 0xfe, 0x00, 0xff};
    const static unsigned char picto_24[] PROGMEM = {
        8, 8,
        0xff, 0x00, 0xff, 0xff, 0xff, 0xff, 0x00, 0xff};
    const static unsigned char picto_30[] PROGMEM = {
        8, 8,
        0xfe, 0x03, 0x01, 0x01, 0x01, 0x01, 0x03, 0xfe};
    const static unsigned char picto_31[] PROGMEM = {
        8, 8,
        0xfe, 0x03, 0x81, 0xc1, 0xc1, 0x81, 0x03, 0xfe};
    const static unsigned char picto_32[] PROGMEM = {
        8, 8,
        0xfe, 0x03, 0xe1, 0xf1, 0xf1, 0xe1, 0x03, 0xfe};
    const static unsigned char picto_33[] PROGMEM = {
        8, 8,
...
const unsigned char *AlbumStretchyHorizontalProgressBar::GetTile(unsigned char blockType, unsigned char fillNumber)
{
    const static unsigned char picto_11[] PROGMEM = {
        8, 8,
...
const unsigned char *AlbumStretchyVerticalScrollBar::GetTile(unsigned char blockType, unsigned char fillNumber)
{
    static const unsigned char picto_10[] PROGMEM = {
        8, 8,  // 8x8
        0x7f, 0xc0, 0x80, 0x80, 0x80, 0x80, 0xc0, 0x7f
    };

    static const unsigned char picto_11[] PROGMEM = {
        8, 8,  // 8x8
        0x7f, 0xc0, 0xb0, 0xb0, 0xb0, 0xb0, 0xc0, 0x7f
    };

    static const unsigned char picto_12[] PROGMEM = {
        8, 8,  // 8x8
        0x7f, 0xc0, 0x8c, 0x8c, 0x8c, 0x8c, 0xc0, 0x7f
    };

    static const unsigned char picto_13[] PROGMEM = {
        8, 8,  // 8x8
        0x7f, 0xc0, 0x83, 0x83, 0x83, 0x83, 0xc0, 0x7f
    };

    static const unsigned char picto_14[] PROGMEM = {
        8, 8,  // 8x8
        0x7f, 0xc0, 0x80, 0x80, 0x80, 0x80, 0xc0, 0x7f
    };

    static const unsigned char picto_20[] PROGMEM = {
        8, 8,  // 8x8
        0xff, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xff
    };

    static const unsigned char picto_21[] PROGMEM = {
        8, 8,  // 8x8
        0xff, 0x00, 0xc0, 0xc0, 0xc0, 0xc0, 0x00, 0xff
    };

    static const unsigned char picto_22[] PROGMEM = {
        8, 8,  // 8x8
        0xff, 0x00, 0x18, 0x18, 0x18, 0x18, 0x00, 0xff
    };

    static const unsigned char picto_23[] PROGMEM = {
        8, 8,  // 8x8
        0xff, 0x00, 0x03, 0x03, 0x03, 0x03, 0x00, 0xff
    };

    static const unsigned char picto_24[] PROGMEM = {
        8, 8,  // 8x8
        0xff, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xff
    };

    static const unsigned char picto_30[] PROGMEM = {
        8, 8,  // 8x8
        0xfe, 0x03, 0x01, 0x01, 0x01, 0x01, 0x03, 0xfe
    };

    static const unsigned char picto_31[] PROGMEM = {
        8, 8,  // 8x8
        0xfe, 0x03, 0xc1, 0xc1, 0xc1, 0xc1, 0x03, 0xfe
    };

    static const unsigned char picto_32[] PROGMEM = {
        8, 8,  // 8x8
        0xfe, 0x03, 0x31, 0x31, 0x31, 0x31, 0x03, 0xfe
    };

    static const unsigned char picto_33[] PROGMEM = {
        8, 8,  // 8x8
...
const unsigned char *AlbumStretchyHorizontalScrollBar::GetTile(unsigned char blockType, unsigned char fillNumber)
{
    static const unsigned char picto_10[] PROGMEM = {
        8, 8,  // 8x8
        0x7e, 0xc3, 0x81, 0x81, 0x81, 0x81, 0x81, 0x81
