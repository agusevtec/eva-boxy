...
[**ClassList**](annotated.md) **>** [**evab**](namespaceevab.md) **>** [**LayoutBase**](classevab_1_1_layout_base.md)



_Abstract base class for composite elements with circular focus chain._ [More...](#detailed-description)
...
```C++
virtual bool evab::LayoutBase::Key (
    Keys aKey
) override
```
...
* `aChild` Child element to set as focused 
