...
# Class BoxyBatteryIndicator



[**ClassList**](annotated.md) **>** [**BoxyBatteryIndicator**](class_boxy_battery_indicator.md)
...
| Type | Name |
| ---: | :--- |
|  void | [**SetVoltage**](#function-setvoltage) (float aVoltage) <br> |
...
```C++
void BoxyBatteryIndicator::SetVoltage (
    float aVoltage
) 
```
...
------------------------------
The documentation for this class was generated from the following file `src/BoxyBatteryIndicator.h`
