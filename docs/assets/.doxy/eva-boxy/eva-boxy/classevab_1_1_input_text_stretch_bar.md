...
[**ClassList**](annotated.md) **>** [**evab**](namespaceevab.md) **>** [**InputTextStretchBar**](classevab_1_1_input_text_stretch_bar.md)
...
```C++
inline void evab::InputTextStretchBar::Increment (
    signed char delta
) 
```
...
```C++
inline virtual void evab::InputTextStretchBar::drawer (
    Screen * aScreen,
    Coor aPos,
    Coor aSize,
