...
# Struct evab::VerticalAlbumPolicy



[**ClassList**](annotated.md) **>** [**evab**](namespaceevab.md) **>** [**VerticalAlbumPolicy**](structevab_1_1_vertical_album_policy.md)
...
```C++
static inline unsigned short evab::VerticalAlbumPolicy::CalculateResolution (
    Coor aSize
) 
```
...
```C++
static inline unsigned short evab::VerticalAlbumPolicy::CalculateTotalBlocks (
    Coor aSize
) 
```
...
```C++
static inline Coor evab::VerticalAlbumPolicy::GetTilePosition (
    Coor aPos,
    Coor aSize,
    unsigned char index,
    unsigned char total
