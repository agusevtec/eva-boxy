...
| Type | Name |
| ---: | :--- |
|  void | [**IndeedDrawer**](class_boxy_input_int_field.md#function-indeeddrawer) ([**Coor**](struct_coor.md) aPos, [**Coor**](struct_coor.md) aSize, unsigned char aSelected, const char \* aName, int aValue) <br> |
