...
# Struct evab::VerticalTilesetPolicy



[**ClassList**](annotated.md) **>** [**evab**](namespaceevab.md) **>** [**VerticalTilesetPolicy**](structevab_1_1_vertical_tileset_policy.md)



_Policy for vertical orientation of stretch bars._ 
...
```C++
static inline unsigned short evab::VerticalTilesetPolicy::CalculateResolution (
    Coor aSize
) 
```
...
```C++
static inline unsigned short evab::VerticalTilesetPolicy::CalculateTotalBlocks (
    Coor aSize
) 
```
...
```C++
static inline Coor evab::VerticalTilesetPolicy::GetRestPosition (
    Coor aPos,
    Coor aSize
) 
```
...
```C++
static inline Coor evab::VerticalTilesetPolicy::GetRestSize (
    Coor aPos,
    Coor aSize
) 
```
...
```C++
static inline Coor evab::VerticalTilesetPolicy::GetTilePosition (
    Coor aPos,
    Coor aSize,
    unsigned char index,
    unsigned char total
