...
| Type | Name |
| ---: | :--- |
|  void | [**IndeedDrawer**](class_boxy_scrollbar_field.md#function-indeeddrawer) ([**Coor**](struct_coor.md) aPos, [**Coor**](struct_coor.md) aSize, unsigned char aSelected, unsigned aPosition, unsigned aCount) <br> |
