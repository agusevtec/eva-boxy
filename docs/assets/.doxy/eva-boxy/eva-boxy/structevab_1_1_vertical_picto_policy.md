...
# Struct evab::VerticalPictoPolicy



[**ClassList**](annotated.md) **>** [**evab**](namespaceevab.md) **>** [**VerticalPictoPolicy**](structevab_1_1_vertical_picto_policy.md)
...
```C++
static inline unsigned short evab::VerticalPictoPolicy::CalculateResolution (
    Coor aSize
) 
```
...
```C++
static inline unsigned short evab::VerticalPictoPolicy::CalculateTotalBlocks (
    Coor aSize
) 
```
...
```C++
static inline Coor evab::VerticalPictoPolicy::GetTilePosition (
    Coor aPos,
    Coor aSize,
    unsigned char index,
    unsigned char total
