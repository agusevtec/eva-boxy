...
# Struct evab::HorizontalAlbumPolicy



[**ClassList**](annotated.md) **>** [**evab**](namespaceevab.md) **>** [**HorizontalAlbumPolicy**](structevab_1_1_horizontal_album_policy.md)
...
```C++
static inline unsigned short evab::HorizontalAlbumPolicy::CalculateResolution (
    Coor aSize
) 
```
...
```C++
static inline unsigned short evab::HorizontalAlbumPolicy::CalculateTotalBlocks (
    Coor aSize
) 
```
...
```C++
static inline Coor evab::HorizontalAlbumPolicy::GetRestPosition (
    Coor aPos,
    Coor aSize
) 
```
...
```C++
static inline Coor evab::HorizontalAlbumPolicy::GetRestSize (
    Coor aPos,
    Coor aSize
) 
```
...
```C++
static inline Coor evab::HorizontalAlbumPolicy::GetTilePosition (
    Coor aPos,
    Coor aSize,
    unsigned char index,
    unsigned char total
