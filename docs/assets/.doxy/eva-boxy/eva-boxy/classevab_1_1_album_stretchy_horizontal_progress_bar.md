...
# Class evab::AlbumStretchyHorizontalProgressBar



[**ClassList**](annotated.md) **>** [**evab**](namespaceevab.md) **>** [**AlbumStretchyHorizontalProgressBar**](classevab_1_1_album_stretchy_horizontal_progress_bar.md)
...
```C++
static const unsigned char * evab::AlbumStretchyHorizontalProgressBar::GetTile (
