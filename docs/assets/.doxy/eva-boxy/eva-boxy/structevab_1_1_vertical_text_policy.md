...
# Struct evab::VerticalTextPolicy



[**ClassList**](annotated.md) **>** [**evab**](namespaceevab.md) **>** [**VerticalTextPolicy**](structevab_1_1_vertical_text_policy.md)



_Policy for vertical text-based stretch bars._ 
...
```C++
static inline unsigned short evab::VerticalTextPolicy::CalculateResolution (
    Coor aSize
) 
```
...
```C++
static inline unsigned short evab::VerticalTextPolicy::CalculateTotalBlocks (
    Coor aSize
) 
```
...
```C++
static inline Coor evab::VerticalTextPolicy::GetTilePosition (
    Coor aPos,
    Coor aSize,
    unsigned char index,
    unsigned char total
